        ...
        >
          ...
          >
            ...
            >
              ...
              <span class="text">
                <b v-if="index == 1">Industrial goods</b>
                <b v-else-if="index == 2">Miscellaneous goods</b>
                <b v-else>Alcoholic goods</b>
              </span>
            </p>
          ...
          >
            <p class="box-detail__type--name d-flex align-items-center">
              <span class="img-product"><router-link to="#"><img
                :src="$format.imageUrl(product.productImg)"
                alt=""
              >
              </router-link></span><span class="name">{{ product.productName }}<router-link to="#" /></span>
            </p>
            <p class="box-detail__type--option">
              {{ product.option }}
            </p>
            ...
            <p class="box-detail__type--price">
              <span>{{ $format.price(product.unitPrice) }}</span>원
            </p>
            <p class="box-detail__type--quantity">
              {{ product.quantity }}
            </p>
            <p class="box-detail__type--total">
              <span>{{ $format.price(product.unitPrice * product.quantity) }}</span>원
            </p>
            <p class="box-detail__type--status">
              {{ product.status }}
            </p>
